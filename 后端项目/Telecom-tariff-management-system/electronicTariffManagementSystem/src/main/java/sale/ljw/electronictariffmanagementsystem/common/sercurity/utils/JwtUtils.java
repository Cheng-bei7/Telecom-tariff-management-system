package sale.ljw.electronictariffmanagementsystem.common.sercurity.utils;
...
public class JwtUtils {
    ...
    public static String sign(String username, Integer userId) {
        ...
        try {
            ...
            token = JWT.create().withHeader(header).withClaim("userId", userId).withClaim("username", username).withExpiresAt(date).sign(algorithm);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
